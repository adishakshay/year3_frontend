...
const Users = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://year3-backend.onrender.com/signup/getall')
      .then(response => {
  ...
  const handleEditSubmit = (e) => {
    ...
    axios.put(`https://year3-backend.onrender.com/adminuser/users/${editedEmail.toLowerCase()}`, updatedUser)
        .then(response => {
  ...
  const handleDelete = (email) => {
    ...
    axios.delete(`https://year3-backend.onrender.com/adminuser/user/${email}`)
      .then(response => {
        if (response.data) {
  ...
  const handleAddUser = (e) => {
    ...
    axios.post('https://year3-backend.onrender.com/signup/add', newUser)
      .then(response => {
